...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-[#000B7E] text-sm font-semibold leading-5 text-slate-900 focus:outline-none focus:border-[#000B7E] transition duration-150 ease-in-out'
