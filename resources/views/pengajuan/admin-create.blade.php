        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-extrabold text-2xl text-slate-900 tracking-tight leading-none">
                    {{ __('Tambah Pengajuan Manual') }}
                </h2>
                <p class="text-xs text-slate-500 mt-1.5 font-medium">Input data pendaftar baru secara manual ke database.</p>
            </div>
    ...
    <div class="py-8 bg-slate-50 min-h-[calc(100vh-140px)]">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white border border-slate-200/80 rounded-[32px] shadow-sm overflow-hidden p-8 sm:p-10 space-y-8">
                ...
                <form action="{{ route('pengajuan.admin.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-1.5">
                            ...
                            <input type="text" id="nama_lengkap" name="nama_lengkap" class="custom-input" placeholder="Masukkan nama lengkap" required value="{{ old('nama_lengkap') }}">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="date" id="tgl_lahir" name="tgl_lahir" class="custom-input" required value="{{ old('tgl_lahir') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-1.5">
                            ...
                            <input type="text" id="no_hp" name="no_hp" class="custom-input" placeholder="Contoh: 081234567890" required value="{{ old('no_hp') }}">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="email" id="email" name="email" class="custom-input" placeholder="Contoh: nama@domain.com" required value="{{ old('email') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-1.5">
                            ...
                            <input type="text" id="pekerjaan" name="pekerjaan" class="custom-input" placeholder="Contoh: Karyawan, Pengusaha" required value="{{ old('pekerjaan') }}">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <label class="cursor-pointer select-none">
                                    <input type="radio" name="status_pernikahan" value="Belum Menikah" class="peer sr-only" checked>
                                ...
                                <label class="cursor-pointer select-none">
                                    <input type="radio" name="status_pernikahan" value="Menikah" class="peer sr-only">
                                    <span class="inline-block px-5 py-2.5 rounded-full border border-slate-200 text-xs font-extrabold text-slate-600 bg-white peer-checked:border-[#000B7E] peer-checked:bg-[#000B7E]/5 peer-checked:text-[#000B7E] transition duration-150">
                                        Sudah Menikah
                                    </span>
                                </label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="alamat_ig" name="alamat_ig" class="custom-input !pl-8" placeholder="username" value="{{ old('alamat_ig') }}">
                            </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-xs font-bold text-slate-400 select-none">@</span>
                                <input type="text" id="alamat_tiktok" name="alamat_tiktok" class="custom-input !pl-8" placeholder="username" value="{{ old('alamat_tiktok') }}">
                            </div>
                            @error('alamat_tiktok') <span class="text-rose-500 text-xs ml-3">{{ $message }}</span> @enderror
                        </div>
                    </div>

                    <!-- Bukti Pembayaran / Upload (Opsional untuk Admin) -->
                    <div class="space-y-1.5">
                        <label class="text-xs font-bold text-slate-400 uppercase tracking-wider block ml-3">Bukti Pembayaran <span class="text-[9px] font-semibold text-slate-400">(Opsional untuk Admin)</span></label>
                        <div class="relative w-full">
                            <input type="file" id="bukti_setor" name="bukti_setor" accept="image/*" class="custom-input py-2">
                        </div>
                        <p class="text-[10px] text-slate-400 ml-3">Format file: JPG, JPEG, PNG, WEBP (maks. 5MB). Jika dikosongkan, sistem akan otomatis menggunakan logo default.</p>
