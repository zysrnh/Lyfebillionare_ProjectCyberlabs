...
<body class="text-slate-800 min-h-screen flex flex-col justify-between selection:bg-[#000B7E] selection:text-white">
    ...
    <main class="flex-grow flex items-center justify-center p-4 sm:p-6">
        <div class="max-w-md w-full bg-white border border-slate-200/80 rounded-[32px] p-8 sm:p-10 shadow-lg text-center space-y-8 relative overflow-hidden">
            
            <!-- Large Company Logo Centered -->
            <div class="flex justify-center pt-2">
                <img src="{{ asset('logo/Logo.png') }}" class="h-28 sm:h-32 w-auto object-contain transition-transform duration-300 hover:scale-105" alt="LyfeBillionaires Logo">
            </div>
            ...
            <div class="pt-4 border-t border-slate-100 flex justify-center items-center gap-1.5 text-[10px] text-slate-400 font-bold">
